...
- Photostrip: 146 template bawaan, terdiri dari 26 warna Basic dan 120 tema dekoratif. Seluruh template memiliki identitas LUX Photobooth berupa wordmark, camera mark, monogram, atau tagline yang disesuaikan dengan gaya kategorinya. Kategori Social Media memakai layout yang lebih rapat dengan slot foto lebih lebar, jarak antarfoto lebih kecil, tipografi UI lebih besar, dan footer khusus agar likes, replies, caption, serta action bar tidak saling bertabrakan. Nama akun Instagram dan TikTok menggunakan `luxphotobooth.id`.
